    ...
    return (
      <div>
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: "2px", marginTop: "2px" }}>
          {plannedCount > 0 && (
            <span
              style={{ width: "8px", height: "8px", backgroundColor: "red", borderRadius: "50%" }}
              title={`${plannedCount} planned task${plannedCount > 1 ? "s" : ""}`}
            />
          )}
          {inProgressCount > 0 && (
            <span
              style={{ width: "8px", height: "8px", backgroundColor: "orange", borderRadius: "50%" }}
              title={`${inProgressCount} task${inProgressCount > 1 ? "s" : ""} in progress`}
            />
          )}
          {completeCount > 0 && (
            <span
              style={{ width: "8px", height: "8px", backgroundColor: "green", borderRadius: "50%" }}
