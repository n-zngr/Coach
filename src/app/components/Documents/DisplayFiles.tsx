                    ...
                    <ul className="flex flex-col gap-4">
                        {files.map((file) => (
                            <button
                                ...
                                className="group flex items-center text-left p-4 gap-4 border rounded-lg hover:bg-white-800 hover:dark:bg-black-200 transition-colors duration-300"
                            >
                                <div className="flex justify-center items-center w-12 h-12 border border-black-500 dark:border-white-500 rounded-md">
                        ...
                        {links.map((link) => (
                            <button
                                ...
                                className="group flex items-center text-left p-4 gap-4 border rounded-lg hover:bg-white-800 dark:hover:bg-black-200 transition-colors duration-300"
                            >
                                <div className="flex justify-center items-center w-12 h-12 border border-black-500 dark:border-white-500 rounded-md">
