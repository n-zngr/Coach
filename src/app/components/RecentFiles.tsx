        ...
        <div>
            ...
            <div className="flex flex-1 flex-wrap gap-4 mb-8">
                {files.map((file) => (
                    ...
                    ">
                        <div>
                            <div className="flex justify-center w-12 h-12 rounded-lg bg-neutral-200 dark:bg-neutral-800">
                                <svg className="self-center h-8 w-8" width="13" height="16" viewBox="0 0 13 16" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex flex-col text-left">
                            <p className="font-bold text-neutral-900 dark:text-white">{file.filename}</p>
